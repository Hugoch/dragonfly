...
void RegisterTopkFamily(CommandRegistry* registry) {
  ...
  *registry << CI{"TOPK.RESERVE", CO::JOURNALED | CO::DENYOOM | CO::FAST, -3, 1, 1, acl::BLOOM}.HFUNC(
                   Reserve)
